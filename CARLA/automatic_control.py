...
MONGO_CLIENT = MongoClient("mongodb+srv://root:mongoPassword@cluster0.a5yk3.mongodb.net/AVRental?retryWrites=true&w=majority")
#MONGO_CLIENT = MongoClient("mongodb+srv://root:root@cluster0.kglve.mongodb.net/cluster0?retryWrites=true&w=majority")
CITY = random.choice(['San Jose', 'Santa Clara', 'San Fransisco'])
...
class HUD(object):
    ...
    def tick(self, world, clock):
        ...
        self._info_text = [
            ...
            '']
        sensor_db = MONGO_CLIENT["sensor_frame_data"]
